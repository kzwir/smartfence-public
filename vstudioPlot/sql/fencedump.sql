...
--
-- Host: mariaDB
-- Czas generowania: 28 Lis 2022, 14:43
...
ALTER TABLE `message`
  ...
  ADD UNIQUE KEY `unique_index` (`date`,`id_central`,`name_central`),
...
--
ALTER TABLE `photovoltaics`
  MODIFY `id_photovoltaics` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
